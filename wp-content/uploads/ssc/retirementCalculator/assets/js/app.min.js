...
this.activeTarget=b,this.clear();var c=this.selector+'[data-target="'+b+'"],'+this.selector+'[href="'+b+'"]',d=a(c).parents("li").addClass("active");d.parent(".dropdown-menu").length&&(d=d.closest("li.dropdown").addClass("active")),d.trigger("activate.bs.scrollspy")},b.prototype.clear=function(){a(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var d=a.fn.scrollspy;a.fn.scrollspy=c,a.fn.scrollspy.Constructor=b,a.fn.scrollspy.noConflict=function(){return a.fn.scrollspy=d,this},a(window).on("load.bs.scrollspy.data-api",function(){a('[data-spy="scroll"]').each(function(){var b=a(this);c.call(b,b.data())})})}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.tab");e||d.data("bs.tab",e=new c(this)),"string"==typeof b&&e[b]()})}var c=function(b){this.element=a(b)};c.VERSION="3.3.7",c.TRANSITION_DURATION=150,c.prototype.show=function(){var b=this.element,c=b.closest("ul:not(.dropdown-menu)"),d=b.data("target");if(d||(d=b.attr("href"),d=d&&d.replace(/.*(?=#[^\s]*$)/,"")),!b.parent("li").hasClass("active")){var e=c.find(".active:last a"),f=a.Event("hide.bs.tab",{relatedTarget:b[0]}),g=a.Event("show.bs.tab",{relatedTarget:e[0]});if(e.trigger(f),b.trigger(g),!g.isDefaultPrevented()&&!f.isDefaultPrevented()){var h=a(d);this.activate(b.closest("li"),c),this.activate(h,h.parent(),function(){e.trigger({type:"hidden.bs.tab",relatedTarget:b[0]}),b.trigger({type:"shown.bs.tab",relatedTarget:e[0]})})}}},c.prototype.activate=function(b,d,e){function f(){g.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),h?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade"),b.parent(".dropdown-menu").length&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),e&&e()}var g=d.find("> .active"),h=e&&a.support.transition&&(g.length&&g.hasClass("fade")||!!d.find("> .fade").length);g.length&&h?g.one("bsTransitionEnd",f).emulateTransitionEnd(c.TRANSITION_DURATION):f(),g.removeClass("in")};var d=a.fn.tab;a.fn.tab=b,a.fn.tab.Constructor=c,a.fn.tab.noConflict=function(){return a.fn.tab=d,this};var e=function(c){c.preventDefault(),b.call(a(this),"show")};a(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',e).on("click.bs.tab.data-api",'[data-toggle="pill"]',e)}(jQuery),+function(a){"use strict";function b(b){return this.each(function(){var d=a(this),e=d.data("bs.affix"),f="object"==typeof b&&b;e||d.data("bs.affix",e=new c(this,f)),"string"==typeof b&&e[b]()})}var c=function(b,d){this.options=a.extend({},c.DEFAULTS,d),this.$target=a(this.options.target).on("scroll.bs.affix.data-api",a.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",a.proxy(this.checkPositionWithEventLoop,this)),this.$element=a(b),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};c.VERSION="3.3.7",c.RESET="affix affix-top affix-bottom",c.DEFAULTS={offset:0,target:window},c.prototype.getState=function(a,b,c,d){var e=this.$target.scrollTop(),f=this.$element.offset(),g=this.$target.height();if(null!=c&&"top"==this.affixed)return e<c&&"top";if("bottom"==this.affixed)return null!=c?!(e+this.unpin<=f.top)&&"bottom":!(e+g<=a-d)&&"bottom";var h=null==this.affixed,i=h?e:f.top,j=h?g:b;return null!=c&&e<=c?"top":null!=d&&i+j>=a-d&&"bottom"},c.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(c.RESET).addClass("affix");var a=this.$target.scrollTop(),b=this.$element.offset();return this.pinnedOffset=b.top-a},c.prototype.checkPositionWithEventLoop=function(){setTimeout(a.proxy(this.checkPosition,this),1)},c.prototype.checkPosition=function(){if(this.$element.is(":visible")){var b=this.$element.height(),d=this.options.offset,e=d.top,f=d.bottom,g=Math.max(a(document).height(),a(document.body).height());"object"!=typeof d&&(f=e=d),"function"==typeof e&&(e=d.top(this.$element)),"function"==typeof f&&(f=d.bottom(this.$element));var h=this.getState(g,b,e,f);if(this.affixed!=h){null!=this.unpin&&this.$element.css("top","");var i="affix"+(h?"-"+h:""),j=a.Event(i+".bs.affix");if(this.$element.trigger(j),j.isDefaultPrevented())return;this.affixed=h,this.unpin="bottom"==h?this.getPinnedOffset():null,this.$element.removeClass(c.RESET).addClass(i).trigger(i.replace("affix","affixed")+".bs.affix")}"bottom"==h&&this.$element.offset({top:g-b-f})}};var d=a.fn.affix;a.fn.affix=b,a.fn.affix.Constructor=c,a.fn.affix.noConflict=function(){return a.fn.affix=d,this},a(window).on("load",function(){a('[data-spy="affix"]').each(function(){var c=a(this),d=c.data();d.offset=d.offset||{},null!=d.offsetBottom&&(d.offset.bottom=d.offsetBottom),null!=d.offsetTop&&(d.offset.top=d.offsetTop),b.call(c,d)})})}(jQuery);function recalc_onclick(e){ssc.recalcSource=e,co.XLEW_1_3_4=eeparseFloat(document.getElementById("XLEW_1_3_4").value),co.XLEW_1_4_4=eeparseFloat(document.getElementById("XLEW_1_4_4").value),co.XLEW_1_5_4=eeparseFloatTh(document.getElementById("XLEW_1_5_4").value),co.XLEW_1_6_6=eeparseFloat(document.getElementById("XLEW_1_6_6").value),calc(co),void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&1==ssc.realtimesync.connection.readyState?ssc.realtimesync.coUpdate(co,e):void 0!==ssc&&void 0!==ssc.realtimesync&&ssc.realtimesync.wsUrl&&ssc.realtimesync.IsCloseByError&&!ssc.realtimesync.IsErrorMsgDialogShown&&(alert("Realtime-Sync is Disconnected, This Form will not save in server and will not collaborate with your partner.")||(ssc.realtimesync.IsErrorMsgDialogShown=!0)),document.getElementById("XLEW_1_5_6").value=eedisplayFloatNDTh(co.XLEW_1_5_6,2),document.getElementById("XLEW_1_6_4").value=eedisplayFloat(co.XLEW_1_6_4),document.getElementById("XLEW_1_7_4").value=eedisplayFloat(co.XLEW_1_7_4)}function myIsNaN(e){return isNaN(e)||"number"==typeof e&&!isFinite(e)}function round(e,t){if(isFinite(e)&&isFinite(t)){var n=0>e?-1:1,i=Math.abs(e),r=Math.pow(10,t);return n*Math.round(i*r)/r}return NaN}function eeparseFloat(e){e=String(e).replace(eedecreg,".");var t=parseFloat(e);return isNaN(t)?0:t}function eedisplayFloat(e){if(myIsNaN(e))return Number.NaN;var t=String(e);return near0RegExp.test(t)&&(e=round(e,8),t=String(e)),t.replace(/\./g,eedec)}function eeparseFloatTh(e){e=String(e).replace(eethreg,""),e=String(e).replace(eedecreg,".");var t=parseFloat(e);return isNaN(t)?0:t}function eedisplayFloatNDTh(e,t){if(myIsNaN(e))return Number.NaN;var n=round(e,t);if(t>0){var i=String(n);if(-1!=i.indexOf("e"))return i;if(-1!=i.indexOf("E"))return i;var r=i.split("."),a=eeinsertThousand(r[0].toString());if(r.length<2){var s="00000000000000".substring(0,t);return a+eedec+s}var s=(r[1].toString()+"00000000000000").substring(0,t);return a+eedec+s}return eeinsertThousand(n.toString())}function eeinsertThousand(e){if(""==e||e.indexOf("e")>=0)return e;var t="";"-"==e.charAt(0)&&(t="-",e=e.substring(1));for(var n="",i=e.length-1,r=0;i>=r;r++)r>0&&r%3==0&&(n=eeth+n),n=e.charAt(i-r)+n;return t+n}function postcode(){}function TriggerOnchange(e){var t=jQuery.Event("change");$("#"+e).trigger(t)}function submitClick(e){if(focused=!1,ssc.asyncRecalc=!1,recalc_onclick("submit"),ssc.asyncRecalc=!0,ssc.pendingUploads>0)return alert("Please wait until all attachments have finished uploading."),!1;var t=$(".error").filter(":hiddenByParent").length;if(t>0)return showValidateMessage(ssc.exMsg+" : "+t+(t>1?" errors":" error"),"Form validation"),"function"==typeof ssc.focusOnElement&&ssc.focusOnElement($(".error").first()),!1;var n=[];$("input:file").each(function(e,t){var i=$(this).data("files");n=n.concat(i)});for(var i=n.length,r=0;i>r;r++)$("#formc").append("<input type='hidden' id='"+["xll_fileid"+r]+"' name='"+["xll_fileid"+r]+"' value='"+n[r].id+"'/>");$("#formc").submit()}function printClick(){recalc_onclick(""),$("#printAllTheme").remove(),window.print()}function LoadFromQueryString(){var e=decodeURI(document.location.search),t=!1;e.indexOf("_readonly")>-1&&(t=!0),e.length>0&&$.each(e.substr(1).split("&"),function(e,t){var n=t.split("=");if(2==n.length){var i=n[0].toString(),r=n[1].toString();ssc.formBinder.bind(i,r)}})}function navigate(e){var t=e.keyCode|e.which;if(13==t||40==t||38==t){var n=$(e.target||e.srcElement);if(!n.is("textarea")&&(!n.is("select")||38!=t&&40!=t)){for(var i=parseInt(n.attr("data-sheet"),10),r=parseInt(n.attr("data-row"),10),a=parseInt(n.attr("data-col"),10),s=!1,o=$("#sheet-"+i),c='input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea',l=r+1,d=r-1,f=l,u=d;40==t&&f>=l||38==t&&d>=u;){var g=o.find(c).filter("[data-sheet="+i+"][data-row="+(38==t?d:l)+"][data-col="+a+"]");if(g.length>0){g.focus(),g.is("input:text, textarea")&&g.select(),s=!0;break}var m;void 0==o.data("col"+a)?(m=o.find(c).filter("[data-sheet="+i+"][data-col="+a+"]").map(function(){return parseInt($(this).attr("data-row"),10)}).toArray(),o.data("col"+a,m)):m=o.data("col"+a),f=m[m.length-1],u=m[0];var h="indexOf"in Array.prototype?m.indexOf(r):$.inArray(r,m);if(40==t&&f>r)l=m[h+1];else{if(!(38==t&&r>u))break;d=m[h-1]}}if(!s){var p;p=38==t?parseInt(n.attr("tabindex"),10)-1:parseInt(n.attr("tabindex"),10)+1;var v=o.find(c).filter("[data-sheet][data-row][data-col][tabindex="+p+"]");if(v.length>0)v.is(":radio")&&(v=v.filter(":checked")),v.length>0&&(v.focus(),v.is("input:text, textarea")&&v.select());else{var y=o.find(c).filter("[data-sheet][data-row][data-col][tabindex]:first");y.focus(),y.is("input:text, textarea")&&y.select()}}e.preventDefault?e.preventDefault():e.returnValue=!1}}}function showValidateMessage(e,t){toastr?t&&t.length>0?toastr.error(e,t):toastr.error(e):alert(e)}function resetClick(){void 0!==ssc&&void 0!==ssc.realtimesync&&void 0!==ssc.realtimesync.connection&&(ssc.realtimesync.connection.close(),ssc.realtimesync.connected=!1,ssc.realtimesync.ShowDisconnectAlert($(".toolbar-panel-right"))),document.formc.reset(),postcode(),LoadFromQueryString(),recalc_onclick("reset")}var eeisus=0,eetrue="TRUE",eefalse="FALSE",eedec=".",eeth=",",eedecreg=new RegExp("\\.","g"),eethreg=new RegExp(",","g"),eecurrencyreg=new RegExp("₱","g"),eepercentreg=new RegExp("%","g"),co=new Object,near0RegExp=new RegExp("[.](.*0000000|.*9999999)");jQuery.expr[":"].hiddenByParent=function(e){if(e.id.startsWith("xl_"))return!0;var t=!1,n=$(e);return void 0!=n&&(t="none"!=n.closest("tr[class^='_css']").css("display")),1==t&&(t="none"!=n.closest(".tab-pane>div").css("display")),t};var ssccf1n=function(e,t,n,i){switch(e){case"image":$("#"+t).attr("src",$("#"+i).attr("src"))}},ssccf4n=function(e,t,n,i,r,a,s){},ssc=ssc||{};ssc.pendingUploads=0,ssc.recalcSource="",ssc.APPNAME="retirementCalculator",ssc.exMsg="The fields with the red border are required or invalid.",$(window).on("scroll",function(){var e=$(window);$(".position-fixed-x").css("left",e.scrollLeft()),$(".position-fixed-y").css("top",e.scrollTop())}),ssc.Dialog={},ssc.Dialog.BeforeSubmitDesc="The form is being submitted.",ssc.Dialog.OfflineHeading="Save until online",ssc.Dialog.OfflineDesc="You are currently offline and the submit failed. Do you want to save the submit and send it later when you are online.",ssc.Dialog.OfflineConfirm="Do you want to save?",ssc.Dialog.OfflineSubmitHeading="Offline forms submit confirmation",ssc.Dialog.OfflineSubmitDesc="There are Offline form(s), which are now ready to submit in server.",ssc.Dialog.OfflineSubmitConfirm="Do you want to submit?",ssc.Dialog.FailOfflineHeading="Offline Form submit failed",ssc.Dialog.FailOfflineDesc="Unable to connect to the Internet. Please try submitting the offline forms later in internet connection.",ssc.Dialog.OfflineSubmitWait="It may take sometime to finish all submits depending on the size of offline forms and internet connection.",ssc.Dialog.OfflineSubmitWaitCounter="Left";var focused=!1;!function(e){postcode(),ssc.active_sheet_selector="div.active > div.container-fluid.ssc-responsive-sheet > div.row > section",e("a").on("click",function(t){var n=e(this).attr("href");if("#"==n.slice(0,1)){if(t.preventDefault(),"#"==n)return;var i=e(n);if(0==i.length)return void alert("Oops! This link is broken so can not navigate.");focused=!1,ssc.focusOnElement(i)}}),ssc.focusOnElement=function(t){if(!focused){focused=!0;var n=t.parents(".tab-pane");n.hasClass("active")||e('.nav-tabs a[href="#'+n.attr("id")+'"]').tab("show"),e("html, body").stop().animate({scrollTop:t.offset().top-40},900,"swing",function(){t.focus()})}},e(".btn.btn-sm.button-update").on("click",function(){recalc_onclick("")}),e(".btn.btn-sm.button-reset").on("click",function(){resetClick(this)}),e(".btn.btn-sm.button-print.one").on("click",function(){printClick(this)}),e(".btn.btn-sm.button-submit.spin-button").on("click",function(){submitClick(this)});var t=e('input:not(":hidden,:button,[readonly=readonly],:disabled"),select,a.ui-slider-handle,textarea,a.ui-state-active');void 0!=t&&0==t.filter(":first").hasClass("form-control")&&t.filter(":first").focus(),e("textarea[readonly],input[type=text][readonly]").css("background","transparent")}($),ssc.checkIfMSIE=function(){var e=window.navigator.userAgent,t=e.indexOf("MSIE "),n=e.indexOf(".NET CLR");return!(-1===t&&-1===n)};