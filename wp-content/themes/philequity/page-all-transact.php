...
?>
 ...
 <!-- start page-title -->
 <section class="page-title" style="background: url(<?php echo get_theme_file_uri('/assets/images/transact/transact-banner.jpg'); ?>) center center/cover no-repeat local;">
            <div class="container">
             <!--<div class="row">-->
...
<section class="services-pg-section">
        ...
        <section class="cta " style="margin-bottom: 40px">
            <div class="container">
                <div class="row">
                    <div class="col col-xs-12">
              ...
              <div class="container">
					<div class="panel panel-success">
					  ...
					  <div class="panel-body table-responsive">
                        ...
                        <a style="width: 250px; margin:10px;" href="<?php echo site_url('https://www.facebook.com/') ?>" target="_blank"  class="theme-btn">Share on social media</a>
                        <a style="width: 250px; margin:10px;" href="<?php echo site_url('/procedures')?>"  class="theme-btn">Procedures</a>
                        <a style="width: 250px; margin:10px;"  href="<?php echo site_url('/transact')?>"  class="theme-btn">Open an account</a>
                        </div>
