...
$SQL = "SELECT DATE_FORMAT(date_navps,'%Y') as year FROM dailyfunds WHERE type = 'Philequity PSE Index Fund, Inc' AND status = '1' ORDER BY date_navps ASC LIMIT 1 ";
$SQL_res = mysql_query($SQL);
$SQL_rec = mysql_fetch_array($SQL_res); 
$startpefi = $SQL_rec["year"]; 

$SQL = "SELECT * FROM dailyfunds 
	WHERE type = 'Philequity PSE Index Fund, Inc' AND 
...
$comma = "";
$pcom = "";
$query = "SELECT date_format(date_navps,'%Y') as year FROM `dailyfunds` WHERE `type` = 'Philequity PSE Index Fund, Inc' AND status = '1'
...
for($i=0;$i<$row;$i++){
	...
	// PEFI DATA
	$qry = "(SELECT * FROM dailyfunds WHERE type = 'Philequity PSE Index Fund, Inc' 
						...
						<table class="table table-bordered table-striped">
						  <thead>
							<tr>
							 ...
							 <th class="text-center " colspan="1">PPSE</th>
							</tr>
						  </thead>
