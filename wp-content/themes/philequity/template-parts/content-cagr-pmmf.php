...
$SQL = "SELECT DATE_FORMAT(date_navps,'%Y') as year FROM dailyfunds WHERE type = 'Philequity Peso Bond Fund, Inc' AND status = '1' ORDER BY date_navps ASC LIMIT 1 ";
$SQL_res = mysql_query($SQL);
$SQL_rec = mysql_fetch_array($SQL_res); 
$startpefi = $SQL_rec["year"]; 

$SQL = "SELECT * FROM dailyfunds 
	WHERE type = 'Philequity Peso Bond Fund, Inc' AND 
